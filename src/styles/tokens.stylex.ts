...
export const colors = stylex.defineVars({
   ...
   bgAuth: 'rgb(255, 255, 255)',
   bgBubble: 'rgb(255, 255, 255)',
   border: 'rgb(219, 219, 219)',
   lightBorder: 'rgb(219, 223, 228)',
   ...
   secondaryButtonHover: 'rgb(231, 234, 238)',
   ...
   invertedBg: 'rgb(255, 255, 255)',
   accentFg: 'rgb(0, 0, 0)',
   shadowColor: 'rgb(238, 238, 238)',
   toggleTrack: 'rgb(106, 113, 122)',
});
...
export const darkTheme = stylex.createTheme(colors, {
   ...
   black: 'rgb(0, 0, 0)',
   white: 'rgb(255, 255, 255)',
   invertedBg: 'rgb(0, 0, 0)',
   accentFg: 'rgb(255, 255, 255)',
   shadowColor: 'transparent',
   toggleTrack: 'rgb(43, 48, 54)',
});
