      ...
      <div {...stylex.props(styles.panel)}>
         <div {...stylex.props(styles.captionSection)}>
            <div {...stylex.props(styles.userRow)}>
               <UserAvatar alt="Your profile image" size={30} src={userData?.user_metadata?.avatar_url} />
               <span>zivavu</span>
            </div>
            <textarea
         ...
         <CollapsibleSection title="Share to" open={shareToOpen} onToggle={() => setShareToOpen((o) => !o)}>
         ...
         >
            <p {...stylex.props(styles.accessibilityDesc)}>
               Alt text describes your photos for people with visual impairments. Alt text will be automatically created
         ...
         <CollapsibleSection title="Advanced settings" open={advancedOpen} onToggle={() => setAdvancedOpen((o) => !o)}>
            <SettingRow
