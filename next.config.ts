            ...
            headers: [
               ...
               { key: 'Cross-Origin-Embedder-Policy', value: 'credentialless' },
               {
                  ...
                  value: [
                     ...
                     "connect-src 'self' https://pggvzapkivjgsybyzjok.supabase.co wss://pggvzapkivjgsybyzjok.supabase.co https://image.mux.com https://stream.mux.com https://graphql.lottiefiles.com https://photon.komoot.io",
                     "font-src 'self'",
                     "frame-src 'none'",
                     "object-src 'none'",
                     "base-uri 'self'",
